...
# Form implementation generated from reading ui file 'kelompokGakKerja.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        # item.setText(_translate("MainWindow", "45 deg"))
        # item = self.tableWidget.horizontalHeaderItem(2)
        # item.setText(_translate("MainWindow", "90 deg"))
        # item = self.tableWidget.horizontalHeaderItem(3)
        # item.setText(_translate("MainWindow", "135 deg"))
    ...
    def browseImage(self):
        img, _ = QFileDialog.getOpenFileName(
            MainWindow,
            "Open image file",
            "/Users/teguhsatya/Documents/imgProc",
            "Image files(*.jpg)",
        )
